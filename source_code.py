...
def drive(forward, left):
    print("RED")
    msg = "$" + f'{forward:.2f}' + "," + f'{left:.2f}' + ";"
    print(msg)
    ser.write(msg.encode())


ser = serial.Serial("/dev/ttyTHS0", 115200, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE)
